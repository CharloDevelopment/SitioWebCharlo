      ...
      <Container size="md">
        ...
        <div className="prose prose-neutral dark:prose-invert max-w-none">
          ...
          <p>
            ...
            respetamos tu derecho a la autodeterminación informativa y estamos comprometidos con la
            protección de tus datos personales de acuerdo con la{" "}
            <strong>
          ...
          <ul>
            ...
            <li>
              <strong>De comunicación:</strong> mensajes que nos envías por formularios, WhatsApp o
              email.
            </li>
          </ul>
          ...
          <p>
            ...
            través de este sitio web. Si en el futuro llegamos a requerir este tipo de datos, te lo
            informaremos y solicitaremos tu consentimiento expreso por escrito.
          </p>
          ...
          <p>
            ...
            las condiciones del uso que les damos (<strong>Acceso</strong>). Asimismo, es tu derecho
            solicitar la corrección de tu información personal en caso de que esté desactualizada,
            sea inexacta o incompleta (<strong>Rectificación</strong>); que la eliminemos de
            nuestros registros o bases de datos cuando consideres que la misma no está siendo
            utilizada conforme a los principios, deberes y obligaciones previstas en la normativa (
            <strong>Cancelación</strong>); así como oponerte al uso de tus datos personales para
          ...
          <p>
            Daremos respuesta a tu solicitud en un plazo no mayor a <strong>20 días hábiles</strong>{" "}
            contados a partir de su recepción, y en caso de resultar procedente, se hará efectiva
            dentro de los <strong>15 días hábiles</strong> siguientes a la fecha de comunicación.
          </p>

          <h2>8. Revocación del consentimiento</h2>
          <p>
            Puedes revocar el consentimiento que nos hayas otorgado para el tratamiento de tus datos
            personales enviando una solicitud a <strong>{siteConfig.email}</strong>. Sin embargo, es
            importante que consideres que no en todos los casos podremos atender tu solicitud de
          ...
          <p>
            Nos reservamos el derecho de modificar el presente aviso de privacidad. Cualquier cambio
            sustancial será notificado mediante correo electrónico a los usuarios que nos hayan
            proporcionado sus datos, o mediante un aviso visible en nuestro sitio web.
          </p>
          ...
          <p>
            ...
            (principalmente en Estados Unidos y Europa), por los proveedores de servicios enumerados
            en la sección 5. Garantizamos que estos proveedores cumplen con estándares
          ...
          <p>
            ...
            presumes alguna violación a las disposiciones previstas en la Ley, podrás interponer una
            denuncia o queja ante el{" "}
            <strong>

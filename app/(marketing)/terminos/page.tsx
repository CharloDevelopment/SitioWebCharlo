...
export default function TerminosPage() {
  const breadcrumbSchema = buildBreadcrumbJsonLd([{ label: "Términos", href: "/terminos" }]);
      ...
      <SectionWrapper spacing="lg">
        <Container size="md">
          ...
          <div className="prose prose-neutral dark:prose-invert max-w-none">
            ...
            <p>
              El uso de este sitio web y de los servicios de Charlo implica la aceptación plena de
              los presentes Términos y Condiciones, así como de nuestra{" "}
            ...
            <p>
              Los planes se cobran mensualmente según la tarifa vigente al momento de la
              contratación. Los precios pueden actualizarse con previo aviso de 30 días.
            </p>
            ...
            <p>
              ...
              software) es propiedad de Charlo o de sus licenciantes y está protegido por las leyes
              de propiedad intelectual. No está permitida la reproducción, distribución o
            ...
            <p>
              Nuestra responsabilidad total agregada no excederá el monto total pagado por ti a
              Charlo en los 12 meses anteriores al evento que originó la responsabilidad.
            </p>

            <h2>9. Niveles de servicio (SLA)</h2>
            <p>
              Para clientes del plan Empresa ofrecemos un SLA con disponibilidad del 99.5%. Para
              otros planes, haremos nuestros mejores esfuerzos por mantener el servicio disponible,
              sin garantías formales de uptime.
            </p>

            <h2>10. Modificaciones al servicio y los términos</h2>
            <p>
              Charlo se reserva el derecho de modificar o descontinuar cualquier aspecto del
              servicio en cualquier momento. También podemos actualizar estos términos; los cambios
              serán efectivos al publicarse en esta página. El uso continuado del servicio después

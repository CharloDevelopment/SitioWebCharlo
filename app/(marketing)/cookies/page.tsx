...
export default function CookiesPage() {
  const breadcrumbSchema = buildBreadcrumbJsonLd([{ label: "Cookies", href: "/cookies" }]);
      ...
      <SectionWrapper spacing="lg">
        <Container size="md">
          ...
          <div className="prose prose-neutral dark:prose-invert max-w-none">
            ...
            <p>
              Este sitio web utiliza cookies y tecnologías similares. Al continuar navegando,
              aceptas el uso de cookies según se describe en este aviso. Si no estás de acuerdo,
              puedes rechazar las cookies no esenciales desde el banner o configurar tu navegador.
            </p>

            <h2>¿Qué son las cookies?</h2>
            <p>
              Las cookies son pequeños archivos de texto que un sitio web almacena en tu dispositivo
              cuando lo visitas. Sirven para que el sitio recuerde tus acciones y preferencias
            ...
            <p>
              Eventualmente podríamos usar cookies para mostrarte anuncios relevantes en otros
              sitios web. Por el momento <strong>no usamos cookies de marketing</strong>.
            </p>

            <h2>Cookies de terceros</h2>
            <p>
              Algunos terceros colocan cookies cuando visitas nuestro sitio. Los principales son:
            </p>
            <ul>
              <li>
